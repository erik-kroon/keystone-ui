        ...
        <CoreDialog.Content
          ...
          class={cn(
            classes(
              ...
              "data-[transition-status=ending]:opacity-0",
              "data-[transition-status=starting]:opacity-0",
              "sm:data-[transition-status=ending]:scale-98",
              "sm:data-[transition-status=starting]:scale-98",
            ...
            bottomStickOnMobile() &&
              classes(
                ...
                "max-sm:border-t",
                "max-sm:border-b-0",
                "max-sm:data-[transition-status=ending]:translate-y-4",
                "max-sm:data-[transition-status=starting]:translate-y-4",
