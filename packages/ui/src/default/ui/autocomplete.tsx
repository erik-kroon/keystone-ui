...
export function AutocompleteItem(props: AutocompleteItemProps) {
  ...
  return (
    <CoreAutocomplete.Item
      ...
      class={cn(
        "ui-autocomplete-item flex min-h-8 cursor-pointer select-none items-center rounded-sm px-2 py-1 text-base outline-none data-disabled:pointer-events-none data-highlighted:bg-accent data-highlighted:text-accent-foreground data-disabled:opacity-64 sm:min-h-7 sm:text-sm",
        local.class,
      )}
    />
  );
