    ...
    <div
      ...
      class={cn(
        classes(
          ...
          "shadow-xs/5",
          "in-data-[slot=card-frame]:border-0",
          "in-data-[slot=card-frame]:shadow-none",
        ),
        local.class,
      )}
    />
...
export function TableBody(props: TableBodyProps) {
  ...
  return (
    <tbody
      ...
      class={cn(classes("ui-table-body", "[&_tr:last-child]:border-0"), local.class)}
    />
  );
}
...
export function TableCaption(props: TableCaptionProps) {
  ...
  return (
    <caption
      ...
      class={cn(
        "ui-table-caption mt-0 border-border/64 border-t px-3 py-3 text-center text-muted-foreground text-sm leading-none",
        local.class,
      )}
    />
  );
