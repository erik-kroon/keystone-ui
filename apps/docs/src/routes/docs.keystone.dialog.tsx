...
export const Route = createFileRoute("/docs/keystone/dialog")({
  component: KeystoneDialogDocs,
});
    ...
    <main class="doc-page">
      <div class="doc-shell">
        ...
        <section class="doc-hero">
          <div>
            <p class="eyebrow">Keystone primitive</p>
            <h1>Dialog</h1>
            <p class="doc-lede">
              An unstyled Solid primitive for modal and non-modal dialog behavior. Keystone owns
              focus, dismissal, layering, ARIA relationships, and the styling contract.
            </p>
          </div>

          <div class="doc-fact-panel" aria-label="Dialog implementation facts">
            <span>Package</span>
            <strong>@keystone-ui/keystone/dialog</strong>
        ...
        <section class="doc-two-column">
          <DocSection icon={<Code2 size={19} />} title="Install">
            ...
            <pre>
              <code>{`bun add @keystone-ui/keystone solid-js`}</code>
            </pre>
          </DocSection>

          <DocSection icon={<BookOpen size={19} />} title="Usage">
            <pre>
              <code>{`import { Dialog } from "@keystone-ui/keystone/dialog";
        ...
        <section class="doc-two-column">
          ...
          <DocSection icon={<BookOpen size={19} />} title="Deeper Context">
            <div class="doc-link-list">
              ...
              <a href="https://github.com/erik-kroon/keystone-ui/blob/main/docs/accessibility/testing-plan.md">
