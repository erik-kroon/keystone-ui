...
export const Route = createFileRoute("/docs/core/contracts")({
  component: CoreContractsDocs,
});

const initialScope = "dialog";

function CoreContractsDocs() {
    ...
    <main class="doc-page">
      <div class="doc-shell">
        ...
        <section class="doc-hero">
          <div>
            <p class="eyebrow">Core contracts</p>
            <h1>Primitive metadata</h1>
            <p class="doc-lede">
              Public primitive contracts are rendered from Core part metadata plus docs notes for
              roles, keyboard behavior, ARIA, SSR, and examples. This page is the broad contract
