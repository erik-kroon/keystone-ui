...
export const Route = createFileRoute("/docs/ui/text-field")({
  component: UiTextFieldDocs,
});

const dependencyNotes = [
  "@tanstack/solid-form owns app-grade field state, validation, blur, and submit flow.",
  "@keystone-ui/core/form provides generic form-control IDs, ARIA relationships, and state accessors.",
  "cn is the registry dependency used for app-owned UI styling hooks.",
];

const boundaryNotes = [
  "Core does not import TanStack Form and remains usable with native forms or other app form libraries.",
      ...
      <div class="doc-shell">
        ...
        <section class="doc-hero">
          <div>
            ...
            <h1>TextField</h1>
            <p class="doc-lede">
              A TanStack Form-backed text field that proves UI can own app form integration while
              Core form-control stays generic and library-agnostic.
            </p>
          </div>

          <div class="doc-fact-panel" aria-label="UI TextField registry facts">
            ...
            <strong>@keystone-ui/core/form</strong>
          </div>
        </section>
  ...
  "files": [{ "path": "ui/text-field.tsx" }]
        ...
        <section class="doc-two-column">
          ...
          <DocSection icon={<Paintbrush size={19} />} title="Customization">
            <p>
              Style installed source through <code>ui-text-field</code> classes and{" "}
              <code>data-part</code> values for root, label, input, description, and error.
            </p>
            <pre>
              <code>{`[data-scope="ui-text-field"][data-part="input"] {
