...
export const Route = createFileRoute("/docs/ui/data-table")({
  component: UiDataTableDocs,
});

const capabilities = [
  "Core, sorted, filtered, faceted, and paginated row models are TanStack Table concerns.",
  "UI owns readable toolbar, header, faceted filter, empty, skeleton, pagination, and row action source.",
      ...
      <div class="doc-shell">
        ...
        <section class="doc-hero">
          <div>
            ...
            <h1>DataTable</h1>
            <p class="doc-lede">
              A TanStack Table data grid starter for Solid apps. It proves UI can ship serious app
              components as editable source without adding table behavior to Keystone.
            </p>
          </div>

          <div class="doc-fact-panel" aria-label="UI DataTable registry facts">
