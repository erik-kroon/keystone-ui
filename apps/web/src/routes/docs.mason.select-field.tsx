...
export const Route = createFileRoute("/docs/mason/select-field")({
  component: MasonSelectFieldDocs,
});

const boundaryNotes = [
  "TanStack Form owns field value, blur, validation, and submit integration.",
  "Keystone Select owns listbox roles, selection, keyboard navigation, typeahead, hidden input reset, and floating geometry.",
  "Mason installs readable source that teams can edit without copying Keystone behavior internals.",
];

function MasonSelectFieldDocs() {
  return (
      ...
      <div class="doc-shell">
        ...
        <section class="doc-hero">
          <div>
            ...
            <h1>SelectField</h1>
            <p class="doc-lede">
              A TanStack Form field adapter around Keystone Select. It proves the app-form vertical
              for listbox selection without moving TanStack dependencies into Keystone.
            </p>
          </div>

          <div class="doc-fact-panel" aria-label="Mason SelectField registry facts">
            ...
            <strong>@keystone-ui/keystone/select</strong>
          </div>
        </section>
  ...
  "registryDependencies": ["cn"]
        ...
        <section class="doc-two-column">
          <DocSection icon={<Layers3 size={19} />} title="Performance Guard">
            <p>
              Keystone Select now has a focused harness for 10, 100, 500, and 1000 mounted items. It
