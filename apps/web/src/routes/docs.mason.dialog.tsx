...
export const Route = createFileRoute("/docs/mason/dialog")({
  component: MasonDialogDocs,
});

const dependencyNotes = [
  "@keystone-ui/keystone provides the dialog behavior runtime.",
...
const customizationNotes = [
  ...
  "Mason must import Keystone behavior instead of copying focus, dismissal, or ARIA internals.",
  "Generated source should remain readable and diffable for future update workflows.",
];

function MasonDialogDocs() {
  return (
      ...
      <div class="doc-shell">
        ...
        <section class="doc-hero">
          <div>
            ...
            <h1>Dialog</h1>
            <p class="doc-lede">
              A copy-paste Solid component entry that belongs to the user project after install.
              Mason owns the registry metadata, dependency plan, and styled source conventions.
            </p>
          </div>

          <div class="doc-fact-panel" aria-label="Mason dialog registry facts">
        ...
        <section class="doc-two-column">
          ...
          <DocSection icon={<BookOpen size={19} />} title="Deeper Context">
            <div class="doc-link-list">
              <a href="https://github.com/erik-kroon/keystone-ui/blob/main/docs/rfcs/mason-registry.md">
                Mason Registry RFC
              </a>
              <a href="https://github.com/erik-kroon/keystone-ui/blob/main/docs/rfcs/keystone-api.md">
                Keystone API RFC
              </a>
              <a href="https://github.com/erik-kroon/keystone-ui/blob/main/docs/adr/0001-keystone-mason-product-boundary.md">
