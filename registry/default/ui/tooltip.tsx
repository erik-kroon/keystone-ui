        ...
        <CoreTooltip.Content
          ...
          class={cn(
            classes(
              ...
              "data-[transition-status=ending]:scale-98",
              "data-[transition-status=starting]:scale-98",
          ...
          <div
            ...
            class={cn(
              classes(
                ...
                "data-instant:transition-none",
                "**:data-current:data-[transition-status=ending]:opacity-0",
                "**:data-current:data-[transition-status=starting]:opacity-0",
                "**:data-previous:data-[transition-status=ending]:opacity-0",
                "**:data-previous:data-[transition-status=starting]:opacity-0",
