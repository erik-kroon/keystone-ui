...
- UI source is distributed through a shadcn-compatible Keystone registry, not a Keystone-specific installer package.
...
- Use the repo-local Keystone skill at [skills/keystone/SKILL.md](skills/keystone/SKILL.md) when building or changing Keystone UI components, primitives, registry source, docs examples, or shadcn/Radix-style migrations.
- Main commands:
  - `bun install`
  - `bun run dev`
  - `bun run build`
