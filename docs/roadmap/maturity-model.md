...
| `collapsible`                   | `./collapsible`     | Experimental | Useful disclosure primitive; measured transition helpers and broader disclosure evidence remain follow-up work.                                                           |
...
| `radio-group`                   | `./radio-group`     | Experimental | Selection-control kernel is promising; validate form/reset, readonly semantics, and composite-widget coordination broadly.                                                |
