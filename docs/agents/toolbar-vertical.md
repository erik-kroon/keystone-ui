...
- Core primitive: `@keystone-ui/core/toolbar`
...
The current vertical is the thin Keystone Core/UI pass against Kobalte and Base UI toolbar patterns. It covers the root role/orientation contract, roving focus across enabled controls, user-handler-first keyboard handling, UI copy-paste wrappers, registry metadata, behavior tests, and docs-visible metadata.
